...
def crop(image, target, region):
    ...
    # Preserve custom per-instance bookkeeping fields (if provided by the dataset)
    # so downstream code can keep annotations aligned after crops filter boxes.
    if target is not None and "instance_idx" in target:
        fields.append("instance_idx")
